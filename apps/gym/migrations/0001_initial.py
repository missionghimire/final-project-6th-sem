# Generated by Django 4.0.4 on 2022-06-19 07:27
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('department', models.CharField(choices=[('GYM', 'GYM'), ('Cardio', 'Cardio'), ('zumba', 'zumba')], max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='Trainer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'pending'), ('Accept', 'Accept'), ('Reject', 'Reject')], default='pending', max_length=100, null=True)),
